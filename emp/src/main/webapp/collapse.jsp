          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col">
                          <label for="exampleInputemergenum">Emergency Contact Person</label>
                      <input type="text" class="form-control" id="id" name="EMERGENCY_CONTACT_PERSON" placeholder="Please Enter Emergency Contact Person">
                    </div>
                    <div class="col">
                          <label for="exampleInputmotname">Mother Name</label>
                      <input type="text" class="form-control" id="id" name="MOTHER_NAME" placeholder="Please Enter Mother Name">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                          <label for="exampleInputPan">Pan Number</label>
                      <input type="text" class="form-control" id="id" name="PAN" placeholder="Please Enter Pan Number">
                    </div>
                    <div class="col">
                          <label for="exampleInputemergeName">Emergency Contact Number</label>
                      <input type="text" class="form-control" id="id" name="EMERGENCY_CONTACT_NUMBER" placeholder="Please Enter Emergency Contact Name">
                    </div>
                    <div class="col">
                          <label for="exampleInputspouse">Spouse Name</label>
                      <input type="text" class="form-control" id="id" name="SPOUSE_NAME" placeholder="Please Enter Spouse Name">
                    </div>
                  </div>
                  <div class="row">
                          <div class="col">
                                  <label for="inputStatus">Marital Status</label>
                                  <select id="inputStatus" id="id" name="IS_MARRIED" class="form-control">
                          ...
                          <div class="col">
                                  ...
                                  <select id="inputnationality" id="id" name="NATIONALITY" class="form-control">
                                    <option selected>---Select One---</option>
                          ...
                          <div class="col">
                              ...
                              <input type="text" class="form-control" id="id" name="PASSPORT" placeholder="Please Enter Passport Number">
                            </div>
                  </div>
                  <div class="row">
                  <div class="col">
                          <label for="inputbloodgrp">Blood Group</label>
                          <select id="inputbloodgrp" id="id" name="BLOOD_GROUP" class="form-control">
                            <option selected>---Select One---</option>
                  ...
                  <div class="col">
                          ...
                          <select id="inputreligion" id="id" name="RELIGION" class="form-control">
                            <option selected>---Select One---</option>
                  ...
                  <div class="col">
                      ...
                      <input type="text" class="form-control" id="id" name="ADHAR" placeholder="Please Enter Aadhar Number">
                    </div>
                  </div>
                  <div class="row">
                          <div class="col">
                                  <label for="inputphysicallych">Physically Challnged</label>
                                  <select id="inputphysicallych" id="id" name="is_challenged" class="form-control">
                                    <option selected>---Select One---</option>
                          ...
                          <div class="col">
                              ...
                              <input type="text" class="form-control" id="id" name="FATHER_NAME" placeholder="Please Enter Father Number">
                            </div>
                            <div class="col-3">
                                  <br>
                                    <button  type="submit" action="collapse.jsp" class="form-control form-control btn btn-outline-secondary"> Submit</button>
