<!DOCTYPE html>
<%@page import="com.covalense.employeemvc.dto.EmployeeOtherInfoBean"%>
<%@page import="com.covalense.employeemvc.dto.EmployeeInfoBean"%>
<html>
<head>
						...
						<div class="row">
							<div class="col">
								<label for="exampleInputEmail1">ID</label> <input type="number"
									name="id" class="form-control" value="<%=infoBean.getId()%>"/>
							</div>
							<div class="col">
						...
						<div class="row">
							...
							<div class="col">
								<label for="exampleInputemergenum">Emergency Contact
									...
									class="form-control" vlaue="<%=infoBean.getEmployeeOtherInfo().getEmergencyContactNumber()%>"/>
							</div>
							<div class="col">
								<label for="exampleInputmotname">Mother Name</label> <input
									type="text" name="employeeOtherInfo.motherName"
									class="form-control" vlaue="<%=infoBean.getEmployeeOtherInfo().getMotherName()%>"/>
							</div>
						</div>
						<div class="row">
							<div class="col">
								<label for="exampleInputPan">Pan Number</label> <input
									...
									vlaue=<%=infoBean.getEmployeeOtherInfo().getPan()%>>
							</div>
							<div class="col">
								<label for="exampleInputemergeName">Emergency Contact
									...
									class="form-control"
									vlaue=<%=infoBean.getEmployeeOtherInfo().getEmegrencyContactPerson()%>>
							</div>
							<div class="col">
								<label for="exampleInputspouse">Spouse Name</label> <input
									type="text" name="employeeOtherInfo.spouseName"
									class="form-control" vlaue=<%=infoBean.getEmployeeOtherInfo().getSpouseName()%>>
							</div>
						</div>
						<div class="row">
							<div class="col">
								<label for="inputStatus">Marital Status</label> <select
									...
									class="form-control" vlaue=<%=infoBean.getEmployeeOtherInfo()%>>
							...
							<div class="col">
								<label for="inputnationality">Nationality</label> <select
									...
									class="form-control" vlaue=<%=infoBean.getEmployeeOtherInfo().getNationality()%>>
									<option selected>---Select One---</option>
							...
							<div class="col">
								<label for="exampleInputpassport">Passport Number</label> <input
									...
									class="form-control" vlaue=<%=infoBean.getEmployeeOtherInfo().getPassport()%>>
							</div>
						</div>
						<div class="row">
							<div class="col">
								<label for="inputbloodgrp">Blood Group</label> <select
									...
									class="form-control" vlaue=<%=infoBean.getEmployeeOtherInfo().getBloodGroup()%>>
									<option selected>---Select One---</option>
							...
							<div class="col">
								<label for="inputreligion">Religion</label> <select
									...
									class="form-control" vlaue=<%=infoBean.getEmployeeOtherInfo().getReligion()%>>
									<option selected>---Select One---</option>
							...
							<div class="col">
								<label for="exampleInputaadhar">Aadhar Number</label> <input
									type="number" name="employeeOtherInfo.adhar"
									class="form-control" vlaue=<%=infoBean.getEmployeeOtherInfo().getAdhar()%>>
							</div>
						</div>
						<div class="row">
							<div class="col">
